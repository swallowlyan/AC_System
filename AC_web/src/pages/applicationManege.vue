...
<el-select v-model="dialogForm.type" :placeholder="appTypeArr.title" style="width:100%">
        <el-option v-for="item in appTypeArr.options"
                                 :key="item.value"
                                 :label="item.label"
                                 :value="item.value">
        </el-option>
...
<el-form-item label="容器类型" prop="containerType">
  <el-col :span="15">
      <el-select v-model="dialogForm.containerType" placeholder="请选择容器类型" style="width:100%">
        <el-option v-for="item in containerTypeArr.options"
                                 :key="item.value"
                                 :label="item.label"
                                 :value="item.value">
        </el-option>
    ...
    export default {
      ...
      data(){
          return {
            ...
            tableData:[
              {name:'应用1',type:'类型1',factory:'厂商1',version:'1.0',createTime:'2019-08-10',containerType:'容器类型1',containerVersion:'1.0'},
              {name:'应用1',type:'类型1',factory:'厂商1',version:'1.0',createTime:'2019-08-10',containerType:'容器类型1',containerVersion:'1.0'},
              {name:'应用1',type:'类型1',factory:'厂商1',version:'1.0',createTime:'2019-08-10',containerType:'容器类型1',containerVersion:'1.0'},
              {name:'应用1',type:'类型1',factory:'厂商1',version:'1.0',createTime:'2019-08-10',containerType:'容器类型1',containerVersion:'1.0'},
              {name:'应用1',type:'类型1',factory:'厂商1',version:'1.0',createTime:'2019-08-10',containerType:'容器类型1',containerVersion:'1.0'},
